/*
	...
	curl https://api.x.ai/v1/chat/completions \
		...
		-H "Authorization: Bearer asi-uDclYK1cili0u3MbcX7ulgzIZjCYzbwWzjpTKHSG4ppKlzVqLhicTy05Eafgwl2xhiBYFlnJzF7wJMVH" \
		-d '{
		"messages": [
			{
			"role": "system",
		...
		entityos.add(
		{
			...
			code: function (param)
			{
				...
				const apiBaseURL = 'https://'
					+ _.get(aiSettings, 'service.host.name', 'api.asi1.ai')
					+ _.get(aiSettings, 'service.host.basePath', '/v1');

                const OpenAI = require("openai");

                const asi = new OpenAI(
                {
                    apiKey: apiKey,
					baseURL: apiBaseURL
                });
