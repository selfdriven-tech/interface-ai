/*
	AI factory | FRIENDLI.AI
	USES OPENAI LIBRARY
	Default model: meta-llama-3.1-8b-instruct
	https://docs.api.friendli.ai/
		...
		entityos.add(
		{
			...
			code: function (param)
			{
				...
				const apiBaseURL = 'https://'
					+ _.get(aiSettings, 'service.host.name', 'api.friendli.ai')
					+ _.get(aiSettings, 'service.host.basePath', 'serverless/v1');
